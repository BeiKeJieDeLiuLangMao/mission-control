...
class LlmFactory:
    ...
    provider_to_class = {
        "ollama": ("app.memory.providers.llms.ollama.OllamaLLM", OllamaConfig),
        "openai": ("app.memory.providers.llms.openai.OpenAILLM", OpenAIConfig),
        "groq": ("app.memory.providers.llms.groq.GroqLLM", BaseLlmConfig),
        ...
        "xai": ("app.memory.providers.llms.xai.XAILLM", BaseLlmConfig),
        "sarvam": ("app.memory.providers.llms.sarvam.SarvamLLM", BaseLlmConfig),
        "lmstudio": ("app.memory.providers.llms.lmstudio.LMStudioLLM", LMStudioConfig),
        "vllm": ("app.memory.providers.llms.vllm.VllmLLM", VllmConfig),
        "langchain": ("app.memory.providers.llms.langchain.LangchainLLM", BaseLlmConfig),
    }
...
class EmbedderFactory:
    provider_to_class = {
        "openai": "app.memory.providers.embeddings.openai.OpenAIEmbedding",
        "ollama": "app.memory.providers.embeddings.ollama.OllamaEmbedding",
        "huggingface": "app.memory.providers.embeddings.huggingface.HuggingFaceEmbedding",
        "azure_openai": "app.memory.providers.embeddings.azure_openai.AzureOpenAIEmbedding",
        "gemini": "app.memory.providers.embeddings.gemini.GoogleGenAIEmbedding",
        "vertexai": "app.memory.providers.embeddings.vertexai.VertexAIEmbedding",
        "together": "app.memory.providers.embeddings.together.TogetherEmbedding",
        "lmstudio": "app.memory.providers.embeddings.lmstudio.LMStudioEmbedding",
        "langchain": "app.memory.providers.embeddings.langchain.LangchainEmbedding",
        "aws_bedrock": "app.memory.providers.embeddings.aws_bedrock.AWSBedrockEmbedding",
        "fastembed": "app.memory.providers.embeddings.fastembed.FastEmbedEmbedding",
    }
...
class VectorStoreFactory:
    provider_to_class = {
        "qdrant": "app.memory.providers.vector_stores.qdrant.Qdrant",
        "chroma": "app.memory.providers.vector_stores.chroma.ChromaDB",
        "pgvector": "app.memory.providers.vector_stores.pgvector.PGVector",
        "milvus": "app.memory.providers.vector_stores.milvus.MilvusDB",
        "upstash_vector": "app.memory.providers.vector_stores.upstash_vector.UpstashVector",
        "azure_ai_search": "app.memory.providers.vector_stores.azure_ai_search.AzureAISearch",
        "azure_mysql": "app.memory.providers.vector_stores.azure_mysql.AzureMySQL",
        "pinecone": "app.memory.providers.vector_stores.pinecone.PineconeDB",
        "mongodb": "app.memory.providers.vector_stores.mongodb.MongoDB",
        "redis": "app.memory.providers.vector_stores.redis.RedisDB",
        "valkey": "app.memory.providers.vector_stores.valkey.ValkeyDB",
        "databricks": "app.memory.providers.vector_stores.databricks.Databricks",
        "elasticsearch": "app.memory.providers.vector_stores.elasticsearch.ElasticsearchDB",
        "vertex_ai_vector_search": "app.memory.providers.vector_stores.vertex_ai_vector_search.GoogleMatchingEngine",
        "opensearch": "app.memory.providers.vector_stores.opensearch.OpenSearchDB",
        "supabase": "app.memory.providers.vector_stores.supabase.Supabase",
        "weaviate": "app.memory.providers.vector_stores.weaviate.Weaviate",
        "faiss": "app.memory.providers.vector_stores.faiss.FAISS",
        "langchain": "app.memory.providers.vector_stores.langchain.Langchain",
        "s3_vectors": "app.memory.providers.vector_stores.s3_vectors.S3Vectors",
        "baidu": "app.memory.providers.vector_stores.baidu.BaiduDB",
        "cassandra": "app.memory.providers.vector_stores.cassandra.CassandraDB",
        "neptune": "app.memory.providers.vector_stores.neptune_analytics.NeptuneAnalyticsVector",
        "turbopuffer": "app.memory.providers.vector_stores.turbopuffer.TurbopufferDB",
    }
...
class GraphStoreFactory:
    ...
    provider_to_class = {
        "memgraph": "app.memory.core.memgraph_memory.MemoryGraph",
        "neptune": "app.memory.providers.graphs.neptune.neptunegraph.MemoryGraph",
        "neptunedb": "app.memory.providers.graphs.neptune.neptunedb.MemoryGraph",
        "kuzu": "app.memory.core.kuzu_memory.MemoryGraph",
        "apache_age": "app.memory.core.apache_age_memory.MemoryGraph",
        "default": "app.memory.core.graph_memory.MemoryGraph",
    }
