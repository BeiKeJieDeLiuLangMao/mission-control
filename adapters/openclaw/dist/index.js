...
function detectLegacyConfig(cfg) {
  ...
  throw new Error(
    `openclaw-mem0 config format has changed. Remove legacy keys: ${legacyFound.join(", ")}. Use "apiUrl" instead (e.g. "http://localhost:8000"). See the plugin README for migration instructions.`
  );
}
